<x-layouts.default>
    <nav class="navbar bg-base-100 rounded-box shadow-base-300/20 shadow-sm border-b-2 sticky top-0 z-50">
        <div class="flex flex-1 items-center">
            <a class="link text-base-content link-neutral text-xl font-bold no-underline"
                href="http://127.0.0.1:8000/name-banan">
                <span> ByteMind</span>
    ...
    <form method="post" action="{{ route("tweet.create") }}"
        ...
        <div class="textarea-floating">
            <textarea required class="textarea border-0 resize-none" placeholder="......." id="content" name="content"></textarea>
            <label class="textarea-floating-label" for="content">غرد هنا</label>
        </div>
        <div class="p-1 pt-0">
            ...
            <button type="submit" class="btn btn-primary btn-square mr-3 mb-2">
